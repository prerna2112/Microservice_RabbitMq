...
namespace MicroRabbitInfraBus
{
    public sealed class RabbitMQBus : IEventBus
    {
        ...
        {
            var factory = new ConnectionFactory() { HostName = "localhost", UserName = "guest", Password = "1234" };
        ...
        {
            var factory = new ConnectionFactory() { HostName = "localhost", UserName = "guest", Password = "1234", DispatchConsumersAsync = true };
